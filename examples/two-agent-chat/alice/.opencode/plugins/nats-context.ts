...
// This example agent (ALICE) drains ONLY its own inbound subject:
//   examples.chat.to_alice
// It receives messages here and replies via its MCP `send_message` tool,
// which publishes to the BOB-ward subject examples.chat.to_bob
// (see ./.opencode/opencode.json for the MCP server binding).
const SUBJECT = "examples.chat.to_alice"
const DURABLE = "example-alice"
const SESSION_ID = "example-alice"
